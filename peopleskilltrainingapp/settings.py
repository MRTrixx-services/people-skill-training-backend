...
MIDDLEWARE = [
    ...
    'apps.webinars.middleware.WebinarAutoCompletionMiddleware',  # Auto-complete webinars after 24h
]
...
# Webinar auto-completion middleware (fallback if Celery Beat is down)
WEBINAR_COMPLETION_INTERVAL = 30  # Minutes between auto-completion checks
