...
# MEDIA_URL = f'https://{SPACES_BUCKET}.{SPACES_ENDPOINT}/media/'
# STATIC_URL = f'https://{SPACES_BUCKET}.{SPACES_ENDPOINT}/static/'
...
# Add this line to include 'media/' prefix in URLs
AWS_LOCATION = 'media'

# Storage Backend
DEFAULT_FILE_STORAGE = 'storages.backends.s3boto3.S3Boto3Storage'

# Update MEDIA_URL to include the location prefix
...
AWS_DEFAULT_ACL = 'public-read'  # Makes all uploads public by default
AWS_QUERYSTRING_AUTH = False     # Removes authentication parameters from URLs
...
EMAIL_HOST_USER = config('EMAIL_HOST_USER', default='support@peopleskilltraining.com')
EMAIL_HOST_PASSWORD = config('EMAIL_HOST_PASSWORD', default='')
DEFAULT_FROM_EMAIL = config('DEFAULT_FROM_EMAIL', default='support@peopleskilltraining.com')
...
EMAIL_TEMPLATE_SETTINGS = {
    ...
    'SUPPORT_EMAIL': config('SUPPORT_EMAIL', default='support@peopleskilltraining.com'),
